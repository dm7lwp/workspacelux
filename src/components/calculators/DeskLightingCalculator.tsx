    ...
    <div className="grid lg:grid-cols-2 gap-6">
      <div className="card p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <NumberField id="desk-width" label={`Desk width (${unitLabel})`} min="1" value={width} onChange={(e) => setWidth(e.target.value)} />
          <NumberField id="desk-depth" label={`Desk depth (${unitLabel})`} min="1" value={depth} onChange={(e) => setDepth(e.target.value)} />
        </div>
        ...
        <NumberField id="ambient-lux" label="Existing ambient light level (lux, optional)" min="0" value={ambientLux} onChange={(e) => setAmbientLux(e.target.value)} />
      </div>
        ...
        {result ? (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <ResultStat label="Desk area" value={formatArea(result.areaM2)} />
